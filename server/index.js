  ...
  if (p.includes("data")) {
    return {
      ...
      subjects: [
        ...
        ["Machine Learning", "Data Mining", "Big Data Basics", "Research Methods"],
  ...
  if (p.includes("cyber")) {
    return {
      ...
      subjects: [
        ...
        ["Network Security", "Cryptography", "Web Security", "Ethical Hacking"],
  ...
  if (p.includes("accounting") || p.includes("finance")) {
    return {
      ...
      subjects: [
        ...
        ["Financial Management", "Audit Basics", "Banking", "Excel for Finance"],
